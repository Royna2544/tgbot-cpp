...
template <>
std::shared_ptr<InputRichBlockSlideshow> parse(const nlohmann::json &data) {
    auto result = std::make_shared<InputRichBlockSlideshow>();
...
template <>
nlohmann::json put(const std::shared_ptr<InputRichBlockSlideshow> &object) {
    JsonWrapper json;
    if (object) {
