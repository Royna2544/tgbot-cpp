...
template <>
std::shared_ptr<PassportElementErrorTranslationFile> parse(const nlohmann::json &data) {
...
template <>
nlohmann::json put(const std::shared_ptr<PassportElementErrorTranslationFile> &object) {
    JsonWrapper json;
    if (object) {
