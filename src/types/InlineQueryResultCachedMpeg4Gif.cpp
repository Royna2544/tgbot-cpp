...
template <>
std::shared_ptr<InlineQueryResultCachedMpeg4Gif> parse(const nlohmann::json &data) {
...
template <>
nlohmann::json put(const std::shared_ptr<InlineQueryResultCachedMpeg4Gif> &object) {
    JsonWrapper json;
    if (object) {
